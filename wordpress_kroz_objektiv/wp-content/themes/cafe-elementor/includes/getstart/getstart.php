    ...
    <div class="inner-cont">
	    ...
	    <div class="tab-sec">
	    	<div class="tab">
				...
				<button class="tablinks" onclick="cafe_elementor_open_tab(event, 'wpelemento_importer_editor')"><?php esc_html_e( 'Demo Import', 'cafe-elementor' ); ?></button>
			...
			<div id="wpelemento_importer_editor" class="tabcontent">
				...
				<?php }else{ ?>
					<div class="tab-outer-box">
						<h2><?php esc_html_e( 'Welcome to Elemento Theme!', 'cafe-elementor' ); ?></h2>
						<p><?php esc_html_e( 'For setup the theme, First you need to click on the Begin activating plugins', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '1. Install Kirki Customizer Framework ', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to Required Plugins Installer ', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '2. Install WPElemento Importer', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to Required Plugins Installer ', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '3. Activate Kirki Customizer Framework ', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '4. Activate WPElemento Importer ', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to the Dashboard', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Click on the start now button', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Click install plugins', 'cafe-elementor' ); ?></p>
						<p><?php esc_html_e( '>> Click import demo button to setup the theme and click visit your site button', 'cafe-elementor' ); ?></p>
					</div>
				<?php } ?>
			</div>
		...
		<div class="inner-side-content">
			...
			<div class="tab-outer-box">
				...
				<div class="iner-sidebar-pro-btn">
					<span class="premium-btn"><a href="<?php echo esc_url( CAFE_ELEMENTOR_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'cafe-elementor'); ?></a>
					</span>
					...
					<span class="doc-btn"><a href="<?php echo esc_url( CAFE_ELEMENTOR_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Pro Doc', 'cafe-elementor'); ?></a>
					</span>
				</div>
				<hr>
				<div class="premium-coupon">
					...
					<div class="coupon-box">
						<h3><?php esc_html_e('Upgrade For $32 (20% Off)', 'cafe-elementor'); ?></h3>
						...
						<div class="coupon-container">
							...
							<p><?php esc_html_e( 'Normally $40. use coupon at checkout.', 'cafe-elementor' ); ?></p>
						</div>
					</div>
				</div>
			</div>	
